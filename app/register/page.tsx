    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-md sm:max-w-lg">
          ...
          {/* Register Form dengan glassmorphism effect */}
          <div className="backdrop-blur-md bg-white/20 dark:bg-white/5 rounded-2xl border border-white/30 dark:border-white/10 shadow-2xl p-6 sm:p-8">
            <RegisterForm onSuccess={() => router.push('/verify-otp')} />
          </div>

          {/* Footer text */}
          <div className="text-center mt-6 sm:mt-8 px-4">
            <p className="text-white/60 dark:text-white/70 text-xs sm:text-sm leading-relaxed">
              "Barangsiapa yang berbuat kebaikan, maka pahalanya untuk dirinya sendiri"
            </p>
            <p className="text-white/40 dark:text-white/50 text-xs mt-2">QS. Fussilat: 46</p>
          </div>
        </div>
      </div>
    </div>
